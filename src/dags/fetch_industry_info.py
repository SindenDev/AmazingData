# -*- coding: utf-8 -*-
"""DAG: amazingdata_fetch_industry_info — 工作日 14:30 拉取行业基础信息与成分。"""
...
_DOCKER_CMD = (
    ...
    "python3 -m amazingdata_fetcher fetch industry_info"
)
...
with DAG(
    ...
    BashOperator(task_id="fetch_industry_info", bash_command=_DOCKER_CMD)
