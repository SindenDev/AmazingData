# -*- coding: utf-8 -*-
"""DAG: amazingdata_fetch_stock_info — 工作日 15:20 拉取股票基础信息与复权因子。"""
...
_DOCKER_CMD = (
    ...
    "python3 -m amazingdata_fetcher fetch stock_info"
)
...
with DAG(
    ...
    BashOperator(task_id="fetch_stock_info", bash_command=_DOCKER_CMD)
